 ...
 * 
 */
public class ActionServersDB extends DBHelper {

	public static final String TABLE_NAME = "action_servers";
	...
	public static String buildCreateTableQuery() {
		...
		builder.append("UNIQUE(").append(COLUMN_NAME_ACTION).append(", ").append(COLUMN_NAME_SERVER).append("), ");
	...
	public ActionServersDB(Context context) {
