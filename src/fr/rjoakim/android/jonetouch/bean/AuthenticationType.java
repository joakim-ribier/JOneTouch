...
public class AuthenticationType {
	...
	public AuthenticationType(AuthenticationTypeEnum type, String label) {
		this.type = type;
		this.label = label;
	}
	...
	public boolean equals(Object object){
		if (object instanceof AuthenticationType) {
			AuthenticationType that = (AuthenticationType) object;
